...
from schemas.definitions import WindowModel, WSectionKeys, WindowKeys
...
class WindowManager(IWindowManager):
    ...
    def get_root_props(self) -> dict:
        return self._sys_json_handler.get_data().get(WSectionKeys.ROOT)
    
    
    def get_toplevel_props(self) -> dict:
        return self._sys_json_handler.get_data().get(WSectionKeys.TOPLEVEL)
